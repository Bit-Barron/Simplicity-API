<div>
  <div class="mt-10">
    <h1 class="flex justify-center text-3xl mr-48">Routes</h1>
    <div class="flex mr-20 mt-10 justify-center">
      <div class="mr-32">GET</div>
      <div class="text-blue-400">/users</div>
    </div>
    <div class="flex mr-16 mt-10 justify-center">
      <div class="mr-32">GET</div>
